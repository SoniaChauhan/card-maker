...
const CATEGORIES = [
  ...
  {
    title: '🔧 Free Video Editing Tools',
    id: 'videotools',
    cards: [
      ...
      { id: 'mp4tomp3',       label: 'MP4 → MP3 Converter',      desc: 'Extract audio from any video — choose quality, convert & download instantly in your browser!', icon: '🎵', badge: '🆕 NEW • Free' },
