                  ...
                  return (
                    <div key={idx} className="mq-item">
                      ...
                      >
                        ...
                        <span className="mq-cat-icon">{q.cat}</span>
                        <div className="mq-card-heading">प्रेरणा ✨</div>
                        <div className="mq-quote-text" style={{ color: cardFont }}>{q.text}</div>
                        <div className="mq-card-footer">
                          <span className="mq-cat-tag">{q.catLabel}</span>
                          <div className="mq-dots">
                            {['#ff6b35','#ffd200','#2ecc71','#3498db','#e74c8b'].map((c, j) => (
